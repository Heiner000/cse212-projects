...
public class TakingTurnsQueueTests
{
    ...
    // ! Defect(s) Found: not re-queuing correctly, improperly declared queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // ! Defect(s) Found: also not re-queuing people correctly, doesn't account for infinite turns
    ...
    // ! Defect(s) Found: negative turns also count as infinite
